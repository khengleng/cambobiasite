...
const phraseTranslations = {
  km: {
    ...
    'PayChain for wallet-as-a-service infrastructure, reserve, treasury, compliance, and reconciliation': 'PayChain សម្រាប់ហេដ្ឋារចនាសម្ព័ន្ធ wallet-as-a-service បម្រុង ទ្រព្យសម្បត្តិរតនាគារ ការអនុលោម និងការផ្សះផ្សា',
    ...
    'Payment flow and wallet infrastructure.': 'លំហូរការទូទាត់ និងហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់។',
    ...
    'Wallets, reserve, treasury, compliance, audit logs, and reconciliation for wallet-as-a-service operators.':
      'កាបូបប្រាក់ បម្រុង រតនាគារ ការអនុលោម កំណត់ហេតុសវនកម្ម និងការផ្សះផ្សា សម្រាប់អ្នកប្រតិបត្តិការ wallet-as-a-service។',
    ...
    'The company story is not eleven unrelated products. The company story is applied software for markets where business workflows, learning workflows, commerce, payments, wallet infrastructure, fundraising access, and operational record-keeping still have large room for digitization.':
      'រឿងរ៉ាវក្រុមហ៊ុនមិនមែនជាផលិតផល ១១ មុខដាច់ពីគ្នាទេ។ វាជាសូហ្វវែរ​ដែលអនុវត្តបានជាក់ស្តែងសម្រាប់ទីផ្សារដែលលំហូរអាជីវកម្ម ការសិក្សា ពាណិជ្ជកម្ម ការទូទាត់ ហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់ ការចូលដល់ការរៃអង្គាសមូលនិធិ និងកំណត់ត្រាប្រតិបត្តិការនៅតែមានឱកាសធំសម្រាប់ឌីជីថលកម្ម។',
    ...
    'Micro-SME Platform, PayKH, PayChain, and Micro-Lending Platform address sales, checkout, wallet infrastructure, and record-heavy financial workflows with clearer software operations.':
      'វេទិកា Micro-SME, PayKH, PayChain និង Micro-Lending ជួយដល់ការលក់ ការទូទាត់ចុងក្រោយ ហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់ និងលំហូរការងារហិរញ្ញវត្ថុដែលមានកំណត់ត្រាច្រើន ដោយមានប្រតិបត្តិការសូហ្វវែរច្បាស់លាស់ជាងមុន។',
    ...
    'Typical fit: stores, resellers, customer-service teams, and operators who need outreach, conversation-based selling, a clearer checkout path, and a future path into stronger wallet infrastructure.':
      'សមស្របសម្រាប់ហាង អ្នកចែកចាយ ក្រុមសេវាកម្មអតិថិជន និងអ្នកប្រតិបត្តិការដែលត្រូវការការផ្សព្វផ្សាយ ការលក់តាមការសន្ទនា ផ្លូវទូទាត់ដែលច្បាស់លាស់ជាងមុន និងផ្លូវបន្តទៅកាន់ហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់ដែលខ្លាំងជាងមុន។',
    ...
    'Best starting mix: Micro-Lending Platform for lending records, Micro-SME Platform for stock and sales flow, and PayKH for merchant collection, with PayChain as the wallet-as-a-service control layer when payment infrastructure grows.':
      'ការចាប់ផ្តើមល្អបំផុត៖ វេទិកា Micro-Lending សម្រាប់កំណត់ត្រាឥណទាន វេទិកា Micro-SME សម្រាប់ស្តុក និងលំហូរការលក់ និង PayKH សម្រាប់ការប្រមូលប្រាក់ពីអាជីវករ ដោយមាន PayChain ជាស្រទាប់គ្រប់គ្រង wallet-as-a-service នៅពេលហេដ្ឋារចនាសម្ព័ន្ធទូទាត់រីកចម្រើន។',
    ...
    'Best when the business wants one channel for high-volume promotion, another for guided customer conversations, and a dedicated layer for payment completion, with PayChain available later if wallet controls and oversight become a bigger need.':
      'សមស្របបំផុតពេលអាជីវកម្មត្រូវការឆានែលមួយសម្រាប់ការផ្សព្វផ្សាយទំហំធំ ឆានែលមួយទៀតសម្រាប់ការសន្ទនាជាមួយអតិថិជនដែលមានការណែនាំ និងស្រទាប់ឯកទេសសម្រាប់ការបញ្ចប់ការទូទាត់ ដោយមាន PayChain សម្រាប់ពេលក្រោយ ប្រសិនបើការគ្រប់គ្រងកាបូបប្រាក់ និងការត្រួតពិនិត្យក្លាយជាតម្រូវការធំជាងមុន។',
    ...
    'Best when the same business serves customers through sales, collects payments, and also manages loan, repayment, or borrower operations behind the scenes, with PayChain as the next step for stronger wallet control and governance.':
      'សមស្របបំផុតពេលអាជីវកម្មតែមួយបម្រើអតិថិជនតាមរយៈការលក់ ប្រមូលការទូទាត់ ហើយក៏គ្រប់គ្រងប្រាក់កម្ចី ការសងប្រាក់ ឬប្រតិបត្តិការអ្នកខ្ចីនៅខាងក្រោយផងដែរ ដោយមាន PayChain ជាជំហានបន្ទាប់សម្រាប់ការគ្រប់គ្រងកាបូបប្រាក់ និងអភិបាលកិច្ចកាន់តែខ្លាំង។',
    ...
    'Use Messenger Hub and the Micro-SME Platform to create stronger customer touchpoints through messaging, then bring PayKH into the flow when payment needs to happen cleanly and PayChain when wallet infrastructure needs a stronger control layer.':
      'ប្រើ Messenger Hub និងវេទិកា Micro-SME ដើម្បីបង្កើតចំណុចប៉ះពាល់អតិថិជនកាន់តែខ្លាំងតាមរយៈការផ្ញើសារ បន្ទាប់មកនាំ PayKH ចូលក្នុងលំហូរ នៅពេលការទូទាត់ត្រូវការការប្រព្រឹត្តទៅយ៉ាងស្អាត និងនាំ PayChain ចូល នៅពេលហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់ត្រូវការស្រទាប់គ្រប់គ្រងកាន់តែខ្លាំង។',
    Learn: 'រៀន',
    ...
    'Use the Micro-SME Platform, PayKH, PayChain, and Micro-Lending Platform to manage sales, checkout, wallet controls, stock, records, and lending activity.':
      'ប្រើវេទិកា Micro-SME, PayKH, PayChain និងវេទិកា Micro-Lending ដើម្បីគ្រប់គ្រងការលក់ ការទូទាត់ចុងក្រោយ ការគ្រប់គ្រងកាបូបប្រាក់ ស្តុក កំណត់ត្រា និងសកម្មភាពឥណទាន។',
    'Messenger Hub + Micro-SME Platform + PayKH': 'Messenger Hub + Micro-SME Platform + PayKH',
    'Micro-SME Platform + PayKH + Micro-Lending Platform': 'Micro-SME Platform + PayKH + Micro-Lending Platform',
    'For customer outreach, messaging campaigns, conversational selling, and stronger order flow from first contact to checkout and payment, with PayChain available when wallet and operational controls become necessary.':
      'សម្រាប់ការឈានដល់អតិថិជន យុទ្ធនាការផ្ញើសារ ការលក់តាមការសន្ទនា និងលំហូរការបញ្ជាទិញកាន់តែខ្លាំងចាប់ពីការទាក់ទងដំបូងរហូតដល់ការទូទាត់ ដោយមាន PayChain នៅពេលការគ្រប់គ្រងកាបូបប្រាក់ និងប្រតិបត្តិការក្លាយជាតម្រូវការ។',
    'Messenger Hub, the Micro-SME Platform, and PayKH create a simple front-to-back sales path for outreach, product inquiry, order capture, and payment completion. PayChain adds the wallet-as-a-service administrative layer later if the same payment environment needs wallet, reserve, or compliance oversight.':
      'Messenger Hub, វេទិកា Micro-SME និង PayKH បង្កើតផ្លូវលក់សាមញ្ញពីមុខទៅក្រោយសម្រាប់ការផ្សព្វផ្សាយ សំណួរផលិតផល ការទទួលការបញ្ជាទិញ និងការបញ្ចប់ការទូទាត់។ PayChain បន្ថែមស្រទាប់រដ្ឋបាល wallet-as-a-service នៅពេលក្រោយ ប្រសិនបើបរិយាកាសទូទាត់ដូចគ្នាត្រូវការការត្រួតពិនិត្យកាបូបប្រាក់ បម្រុង ឬការអនុលោម។',
    'Wallet-as-a-service platform for wallets, reserve, treasury, compliance, reconciliation, and audit-ready control workflows.':
      'វេទិកា wallet-as-a-service សម្រាប់កាបូបប្រាក់ បម្រុង រតនាគារ ការអនុលោម ការផ្សះផ្សា និងលំហូរការងារគ្រប់គ្រងដែលត្រៀមរួចសម្រាប់សវនកម្ម។',
    'Give operators a clearer administrative layer behind wallet and payment activity': 'ផ្តល់ស្រទាប់រដ្ឋបាលកាន់តែច្បាស់នៅខាងក្រោយសកម្មភាពកាបូបប្រាក់ និងការទូទាត់',
    ...
    'Use PayChain when wallet-as-a-service operations need more than front-end collection, including wallet oversight, review queues, approvals, and control-heavy financial administration.':
      'ប្រើ PayChain នៅពេលប្រតិបត្តិការ wallet-as-a-service ត្រូវការលើសពីការប្រមូលប្រាក់ខាងមុខ រួមទាំងការត្រួតពិនិត្យកាបូបប្រាក់ ជួរពិនិត្យ ការអនុម័ត និងការគ្រប់គ្រងហិរញ្ញវត្ថុដែលមានការគ្រប់គ្រងខ្ពស់។',
    'Pair PayChain with PayKH when the same organization needs merchant-facing payment flow and a stronger back-office wallet-as-a-service layer.':
      'ផ្គូផ្គង PayChain ជាមួយ PayKH នៅពេលអង្គការដូចគ្នាត្រូវការលំហូរការទូទាត់មុខអាជីវករ និងស្រទាប់ wallet-as-a-service ខាងក្រោយការិយាល័យដែលខ្លាំងជាងមុន។',
    'Payment operators, fintech teams, treasury reviewers, compliance teams, and founders building controlled wallet infrastructure.':
      'អ្នកប្រតិបត្តិការទូទាត់ ក្រុម fintech អ្នកពិនិត្យរតនាគារ ក្រុមការងារអនុលោម និងស្ថាបនិកដែលកំពុងកសាងហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់ដែលមានការគ្រប់គ្រង។',
    ...
    'Best for: wallet-as-a-service, wallets, reserve, treasury, compliance': 'សមស្របសម្រាប់៖ wallet-as-a-service កាបូបប្រាក់ បម្រុង រតនាគារ និងការអនុលោម',
...
const siteAssistantCopy = {
  en: {
    ...
    payments:
      'PayKH is the payment platform for merchant checkout, transaction support, and KHQR-ready collection flow. PayChain is the wallet-as-a-service platform for wallets, reserve, treasury, compliance, and reconciliation. Use PayKH for the customer-facing payment step and PayChain for the wallet and control layer behind it.',
    lending:
    ...
    paymentsQuestion: 'Do you need merchant checkout only, or do you also need wallet-as-a-service infrastructure, treasury, compliance, or reconciliation behind the payment flow?',
  ...
  km: {
    ...
    business:
      'បើអាទិភាពរបស់អ្នកគឺការឈានដល់អតិថិជន សូមចាប់ផ្តើមពី Messenger Hub។ បើត្រូវការការលក់តាមការសន្ទនា ស្តុក POS ឬការទំនាក់ទំនងអតិថិជនដោយ AI នោះ CXDot គឺសមបន្ទាប់ ហើយ PayKH ចូលមកនៅពេលការបញ្ចប់ការទូទាត់មានសារៈសំខាន់។ PayChain ក្លាយជាជម្រើសសមនៅពេលហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់ បម្រុង រតនាគារ ឬការអនុលោមក៏ត្រូវការការយកចិត្តទុកដាក់ផងដែរ។',
    learning:
    ...
    payments:
      'PayKH គឺជាវេទិកាទូទាត់សម្រាប់ការទូទាត់របស់អាជីវករ ការគាំទ្រប្រតិបត្តិការ និងលំហូរប្រមូលប្រាក់ KHQR-ready។ PayChain គឺជាវេទិកា wallet-as-a-service សម្រាប់កាបូបប្រាក់ បម្រុង រតនាគារ ការអនុលោម និងការផ្សះផ្សា។ ប្រើ PayKH សម្រាប់ជំហានទូទាត់ដែលមើលឃើញដោយអតិថិជន និងប្រើ PayChain សម្រាប់ស្រទាប់កាបូបប្រាក់ និងការគ្រប់គ្រងនៅខាងក្រោយវា។',
    lending:
    ...
    morePayments:
      'PayKH ខ្លាំងបំផុតនៅពេលការទូទាត់មិនត្រូវបានទុកជាជំហានដាច់ដោយឡែកដែលធ្វើដោយដៃ។ វាធ្វើការល្អបំផុតនៅពេល checkout ត្រូវបានភ្ជាប់ត្រឡប់ទៅដំណើរអតិថិជនដែលបង្កើតដោយ Messenger Hub ឬ CXDot។ PayChain កាន់តែសំខាន់នៅពេលបរិយាកាសដូចគ្នានោះក៏ត្រូវការហេដ្ឋារចនាសម្ព័ន្ធកាបូបប្រាក់ ភាពមើលឃើញប្រតិបត្តិការ ការគ្រប់គ្រង និងលំហូរពិនិត្យនៅខាងក្រោយសកម្មភាពទូទាត់ផងដែរ។',
    moreLending:
    ...
    paymentsQuestion: 'តើអ្នកត្រូវការការទូទាត់សម្រាប់អាជីវករប៉ុណ្ណោះ ឬក៏ត្រូវការហេដ្ឋារចនាសម្ព័ន្ធ wallet-as-a-service កាបូបប្រាក់ រតនាគារ ការអនុលោម ឬការផ្សះផ្សានៅខាងក្រោយលំហូរទូទាត់ផងដែរ?',
